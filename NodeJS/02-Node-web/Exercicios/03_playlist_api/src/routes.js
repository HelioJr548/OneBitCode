...
router.get('/musics/title/:title', musicController.getByTitle); // Obter uma musica por TITLE
...
router.get('/playlists/title/:title', playlistController.getByTitle); // Obter uma playlist por TITLE
...
router.post('/playlists/:id/add-music', playlistController.addMusic); // Adicionar música a uma playlist
